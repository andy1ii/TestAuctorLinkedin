...
class Orb {
    ...
    update() {
        ...
        if (currentLayout === 'random') {
            ...
            let slideX = sin(time + this.phaseOffset) * 150 * orbSpacing;
            ...
            let slideX = sin(time + this.phaseOffset) * 120 * orbSpacing;
            ...
            let slideY = sin(time + this.phaseOffset) * 120 * orbSpacing;
            ...
            let slideX = sin(time + this.phaseOffset) * 150 * orbSpacing * direction * depthMultiplier;
            this.currentX = cx + slideX;
            this.currentY = cy;
